...
public class TransactionDA {
    ...
    private void generateStatements() throws SQLException{                                //datetime
    ...
    public Transaction getTransactionInfo(int transactionID)
    {
        ...
        try {
            ...
            if(set.next())
            {                                            //i think time stamp is date time
                trans = new Transaction(set.getInt(1), set.getTimestamp(2).toLocalDateTime(), set.getInt(3), set.getDouble(4), 
